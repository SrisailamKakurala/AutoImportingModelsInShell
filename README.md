# AutoImportingModelsInShell --GSoC 2024 Project
...
class Command(BaseCommand):
    help = (
        ...
        "as code. Auto-imports all models for convenience."
    )
    ...
    def auto_import_models(self):
        """
        Dynamically imports all models from installed apps and returns them
        as a dictionary.
        """
        imported_objects = {}
        for app_config in apps.get_app_configs():
            for model_name, model in app_config.models.items():
                ...
                print(f"Auto-imported: {model_name}")
        return imported_objects

    def ipython(self, options):
        from IPython import start_ipython

        imported_objects = self.auto_import_models()
...
![image](https://github.com/user-attachments/assets/1039623d-a3f3-47c1-a8ef-2e2ed1d7411c)
